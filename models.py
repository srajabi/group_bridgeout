...
from group_bridgeout_fc import GroupBridgeoutFcLayer
...
class TransformerModel(nn.Module):
    ...
    def forward(self, src: Tensor, src_mask: Tensor) -> Tensor:
        ...
        if self.use_pos_embed:
            ...
            tok_emb = self.wte(src)  # token embeddings of shape (s, b, n_embd)
            pos_emb = self.wpe(pos)  # position embeddings of shape (s, b, n_embd)
...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(self, d_model: int, nhead: int,
        ...
        if isinstance(activation, str):
            assert False, "String based activation not supported"
    ...
    def forward(self, src: Tensor, src_mask: Optional[Tensor] = None,
        ...
        why_not_sparsity_fast_path = "WE DON'T WANT IT"
